...
export class NagadService {
  private baseUrl = 'https://api.nagad.com';
  private username = process.env.NAGAD_USERNAME!;
  private password = process.env.NAGAD_PASSWORD!;
  private appKey = process.env.NAGAD_APP_KEY!;
  private appSecret = process.env.NAGAD_APP_SECRET!;
